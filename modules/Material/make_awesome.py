...
def get_awesome_icons():
    ...
    response = requests.get('http://raw.githubusercontent.com/FortAwesome/Font-Awesome/master/scss/_variables.scss')
    icons = []
...
def save_icons(icons, filename):
    ...
    print('Wrote {0} of {1} icons to {2}'.format(saved_count, len(icons), filename))
...
if __name__=='__main__':
    ...
    download_font('http://github.com/FortAwesome/Font-Awesome/raw/master/fonts/FontAwesome.otf',
